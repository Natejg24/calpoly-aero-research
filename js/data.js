 ...
 * publications, equipment, gallery) reads from this array â add one
 ...
 *   specs       array of {label, value} pairs â real apparatus specs, shown as
 ...
 * http:// (a real or local server) â opening index.html by
...
CPA.projects = [
  ...
  },
  {
    ...
    overview: 'The VortexField apparatus (VFa) is two modules of sixteen 120 mm fans each (4Ã4 per module, 32 fans total), independently PWM-driven by a pair of ESP32 DevKit microcontrollers and commanded wirelessly through a custom Python GUI. Because the fansâ circular outlets in square housings created strong radial outflow and gaps between adjacent fans, the team designed 3D-printed circular-to-square diffuser shrouds (116 mm inlet, 116 mm square outlet) paired with 1"-thick aluminum honeycomb to straighten the flow. Smoke visualization and velocity measurements confirmed improved flow alignment downstream of the conditioned outlets, at the cost of some mean-velocity loss from added pressure drop. A full flow-field map of the assembled array revealed a persistent low-speed core near each fan hub, and a benchmark propeller test against the Cal Poly Low-Speed Wind Tunnel (comparing thrust and torque coefficients) showed the VFaâs velocity measurements were an order of magnitude more repeatable than the wind tunnelâs.',
    specs: [
      { label: 'Fan array', value: '32 fans (2 modules Ã 16, 120 mm, 4Ã4 layout)' },
      { label: 'Control', value: '2Ã ESP32 DevKit MCUs, PWM, custom Python GUI' },
      { label: 'Shroud', value: '3D-printed, 116 mm inlet â 116 mm square outlet' },
  ...
  },
  {
    ...
    specs: [
      ...
      { label: 'Sensor', value: 'MEMS differential pressure sensor (IÂ²C)' },
      { label: 'Data acquisition', value: 'Arduino Uno R4 WiFi â Python over Wi-Fi hotspot' },
 ...
 * Returns undefined if no project matches â callers should handle that
