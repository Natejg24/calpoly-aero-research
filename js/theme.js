 ...
 * by a tiny inline script in the <head> of every page â see the
 ...
 *
 * Attaches to window.CPA.initThemeToggle â see the note at the top of
...
(function () {
  ...
  const STORAGE_KEY = 'cp-aero-theme';
  ...
  CPA.initThemeToggle = initThemeToggle;
})();
